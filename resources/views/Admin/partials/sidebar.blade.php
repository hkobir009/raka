    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        ...
        <div class="nk-sidebar-brand">
            <a href="html/index.html" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="{{asset('admin/images/logo.png')}}" srcset="{{asset('admin/images/logo.png')}}" alt="logo">
                <img class="logo-dark logo-img" src="{{asset('admin/images/logo-dark.png')}}" srcset="{{asset('admin/images/logo-dark.png')}}" alt="logo-dark">
            </a>
        </div>
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{route('application')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-user-list"></em></span>
                            <span class="nk-menu-text">Application List</span><span class="nk-menu-badge">HOT</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="{{route('addterms')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-building"></em></span>
                            <span class="nk-menu-text">Add New Terms</span><span class="nk-menu-badge">HOT</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="{{route('create_category')}}" class="nk-menu-link"><span class="nk-menu-text">ADD Category</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="{{route('category')}}" class="nk-menu-link"><span class="nk-menu-text">Show Category</span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
                    </li><!-- .nk-menu-item -->
                    {{-- <li class="nk-menu-heading">
